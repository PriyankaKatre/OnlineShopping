...
import { getKidsProduct } from '../../../../redux/product/productThunk';
  ...
  return (
        <>
          <section className="bg-orange-200">
                <p className="text-3xl px-5 md:px-10 lg:px-20 py-3">kid's Collection</p>
            </section>
                                        ...
                                        <ul className=" border border-black-600 text-center m-4 text-zinc-500">
                                            <li className="">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() =>AddToCartHandler(product)}>Add Cart</button>
                                            </li>
                                        </ul>
                                    </div>
